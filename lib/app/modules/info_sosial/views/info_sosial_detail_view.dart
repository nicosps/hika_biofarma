...
class InfoSosialDetailView extends StatelessWidget {
  ...
  const InfoSosialDetailView({Key? key, required this.data}) : super(key: key);
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  InfoSosialDetailSection(data: data),
                  const SizedBox(height: 30),
...
class InfoSosialDetailSection extends StatelessWidget {
  final InfoSosialModel data;

  const InfoSosialDetailSection({Key? key, required this.data})
      : super(key: key);
