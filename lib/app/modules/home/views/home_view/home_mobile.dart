...
import 'package:hika_biofarma/app/modules/home/controllers/home_controller.dart';
              ...
              (index) {
                ...
                return Padding(
                  padding: EdgeInsets.only(
                    right:
                        index == controller.infoSosialList.length - 1 ? 0 : 20,
                    bottom: 20,
                  ),
            ...
            children: List.generate(
              ...
              (index) {
                ...
                return Padding(
                  padding: EdgeInsets.only(
                    right:
                        index == controller.beritaHikaList.length - 1 ? 0 : 20,
                    bottom: 20,
                  ),
                  child: MaterialButton(
                    onPressed: () => Get.to(
